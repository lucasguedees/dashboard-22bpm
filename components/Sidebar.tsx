      ...
      <div className="p-6 border-b border-gray-900 flex items-center justify-between bg-gray-950">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-[9px] text-blue-500 font-black uppercase mt-1 tracking-widest">SGO / BM</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3 truncate">
            ...
            <div className="truncate">
              <p className="text-xs font-black text-white uppercase truncate leading-none">{user.rank} PM {user.username}</p>
