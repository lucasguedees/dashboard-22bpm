...
const App: React.FC = () => {
  ...
  const handleUpdateUser = (updatedUser: Partial<User>) => {
    setUser(prevUser => {
      ...
      // Salva no localStorage se o usuário estiver com 'lembrar de mim' ativado
      if (localStorage.getItem('22bpm_user')) {
        localStorage.setItem('22bpm_user', JSON.stringify(newUser));
      }
      return newUser;
    });
  };
